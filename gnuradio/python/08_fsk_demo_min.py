...
class fsk_demo_min(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "2-FSK Demo (Baseband) – Minimal Robust", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("2-FSK Demo (Baseband) – Minimal Robust")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fsk_demo_min")
        ...
        labels = ['Quadrature Demod (freq)', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
...
def main(top_block_cls=fsk_demo_min, options=None):
