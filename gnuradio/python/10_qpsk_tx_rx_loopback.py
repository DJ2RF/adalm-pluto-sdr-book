...
# Title: QPSK TX/RX Loopback (Pluto) – ATTENUATOR ONLY
# Author: DJ2RF
...
class qpsk_tx_rx_loopback(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK TX/RX Loopback (Pluto) – ATTENUATOR ONLY", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK TX/RX Loopback (Pluto) – ATTENUATOR ONLY")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_tx_rx_loopback")
        ...
        # Variables
        ##################################################
        self.sym_rate = sym_rate = 50000
        self.samp_rate = samp_rate = 1000000
        self.sps = sps = int(samp_rate/sym_rate)
        self.tx_atten = tx_atten = 40
        self.sym_offset = sym_offset = int(sps/2)
        self.rx_gain = rx_gain = 40
        self.f0 = f0 = 435000000
        ...
        self.qtgui_freq_sink_x_0.set_y_label('RX Spectrum (Loopback)', 'dB')
        ...
        self.iio_pluto_sink_0.set_frequency(f0)
        self.iio_pluto_sink_0.set_samplerate(samp_rate)
        self.iio_pluto_sink_0.set_attenuation(0, 10.0)
        self.iio_pluto_sink_0.set_filter_params('Auto', '', 0, 0)
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(0.02, 4, False)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_sym_offset(int(self.sps/2))
    ...
    def get_sym_offset(self):
        return self.sym_offset

    def set_sym_offset(self, sym_offset):
    ...
    def set_f0(self, f0):
        self.f0 = f0
        self.iio_pluto_sink_0.set_frequency(self.f0)
...
def main(top_block_cls=qpsk_tx_rx_loopback, options=None):
